            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                        <Link className="nav-link active" to="/patients">Clientes</Link>
                    </li>
                    <li className="nav-item">
                    ...
                    <li className="nav-item">
                        <Link className="nav-link active" to="/servic">Serviços</Link>
                    </li>
                    <li className="nav-item">
                        <Link className="nav-link active" to="/admin/managements">Gerenciar Médicos</Link>
                    </li>
                </ul>
